...
@Component({
	selector: 'app-edit',
	templateUrl: './editJadwal.component.html',
	// styleUrls: ['./edit.component.sass']
})
export class editJadwal implements OnInit {
					...
					this.JadwalStaffService.show(params.id)
						.subscribe(async (resp: any) => {
							if (resp.metaData.response_code == '0000') {
								...
								this.listStaff = [{
									id_akun_staff: this.jadwalStaff.id_akun_staff,
									nama_lengkap: this.jadwalStaff.nama_lengkap_staff
								}]
			...
			if (indexJadwal >= 0) {
				...
				control.push(
					this.fb.group({
						...
						jam_selesai: [new Date('1 Apr 2023 '+find.jam_buka), []],
					})
				)
			}
		}
