...
export class ModulFakturPembelianService {

    urlModule: string
    urlBase: string = 'pembelian'
    constructor(
    ...
    add(payload: any): Observable<ResponseApi> {
        const url = this.urlModule + '/' + this.urlBase + '/faktur-obat'
        return this.http.post<ResponseApi>(url, payload)
    }
    update(id: string, payload: any) {
        const url = this.urlModule + '/' + this.urlBase + '/principal/update/' + id
        return this.http.put<ResponseApi>(url, payload)
    }
    delete(id: string) {
        const url = this.urlModule + '/' + this.urlBase + '/principal/delete/' + id
