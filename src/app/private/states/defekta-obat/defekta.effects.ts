...
@Injectable()
export class defektaObatEffects {
    constructor(
    ...
    addInitial$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(action => {
                return this.ModulDefektaObatService.add(action.payload)
                    .pipe(
                        map(res => {
    ...
    updateInitial$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(action => {
                return this.ModulDefektaObatService.update(action.payload)
                    .pipe(
                        map(res => {
    ...
    getByIdInitial$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(action => {
                return this.ModulDefektaObatService.show(action.payload.id)
                    .pipe(
                        map(res => {
    ...
    deleteInitial$ = createEffect(() =>
        this.actions$.pipe(
            ...
            switchMap(action => {
                return this.ModulDefektaObatService.delete(action.payload.id)
                    .pipe(
                        map(res => {
