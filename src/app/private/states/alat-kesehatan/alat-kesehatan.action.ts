...
export const addInitial = createAction(ADD_INITIAL, props<{ payload: AlatKesehatanPayload }>());
...
export const updateInitial = createAction(UPDATE_INITIAL, props<{ payload: AlatKesehatanPayload }>());
...
export const getByIdSuccess = createAction(GET_BYID_SUCCESS, props<{ payload: AlatKesehatanPayload }>());
