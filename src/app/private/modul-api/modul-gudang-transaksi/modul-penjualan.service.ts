...
export class ModulPenjualanService {
    ...
    listRiwayat(payload: any): Observable<ResponseApi> {
        const url = this.urlModule + '/' + this.urlBase + '/get-riwayat-penjualan-datatables'
        return this.http.post<ResponseApi>(url, payload)
    }
    listDatatables(payload: any): Observable<ResponseApi> {
        const url = this.urlModule + '/' + this.urlBase + '/get-kasir-datatables'
        return this.http.post<ResponseApi>(url, payload)
    }
    add(): Observable<ResponseApi> {
        const url = this.urlModule + '/' + this.urlBase + '/create-transaksi'
