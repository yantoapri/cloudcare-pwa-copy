...
export interface State {
    retur: returPayload | null
    returResep:returResep |null
...
const _returReducers  = createReducer(
    ...
    // on(returActions.getByIdInitial, (state, action) => ({ ...state, retur: new returPayload , errorMessage: null, isEdit: false, reloadTable: false })),
    ...
    on(returActions.deleteInitial, (state, action) => ({ ...state, retur: new returPayload , errorMessage: null, isEdit: false, reloadTable: false })),
    ...
    on(returActions.tableData, (state, action) => ({ ...state, retur: new returPayload , reloadTable: true })),
    on(returActions.clearData, (state, action) => ({
        ...state,
        retur: new returPayload ,
        isLoadingButton: false,
        errorMessage: null,
        reloadTable: false,
        submitButton: false,
