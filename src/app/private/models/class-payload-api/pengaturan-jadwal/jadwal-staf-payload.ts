export class JadwalStafPayload {
	id_jadwal_staff: string | null | undefined
	id_akun_staff: string | null | undefined
	...
	nama_staff: string | null | undefined | Date
	nama_ruang: string | null | undefined | Date
	detail: Array<Detail>
}

export class Detail {
	id_jadwal_staff_detail: string | null | undefined
